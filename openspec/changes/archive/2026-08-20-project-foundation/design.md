...
- **What it is**: commerce-ops is internal ops tooling for a company that sells products through online marketplaces.
- **Problem it solves**: consolidates and automates currently manual, fragmented marketplace-operations workflows.
- **Intended audience**: the company's internal operations/support team.
...
`.gitignore` is extended with the corresponding Python/uv exclusions as part of this change (see tasks.md).
