...
- New test asserting handler-module import cost; `tests/agents/subcategory_advisor/test_subcategory_advisor_graph.py` continues to pass unmodified, since it imports the module and calls `build_graph(stub)` exactly as before.
