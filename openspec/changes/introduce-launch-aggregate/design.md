...
- import-linter allows `launch.application → catalog.application` and forbids `launch.domain` from reaching any other module; `shared.domain` (including `Posture`) is open to it.
